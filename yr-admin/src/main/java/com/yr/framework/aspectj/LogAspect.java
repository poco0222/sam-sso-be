...
import com.yr.common.enums.HttpMethod;
...
import com.yr.system.domain.SysOperLog;
 ...
 * @author Youngron
 */
@Aspect//jdk的动态代理  springAOP就是动态代理  目标对象实现了若干接口，使用jdk的动态代理  没有实现若干接口，使用cglib代理
