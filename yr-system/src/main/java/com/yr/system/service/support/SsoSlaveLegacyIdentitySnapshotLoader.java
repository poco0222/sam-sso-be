...
/**
 * 负责从 MySQL `slave` 读取 legacy 身份快照。
 */
@Component
@DataSource(DataSourceType.SLAVE)
public class SsoSlaveLegacyIdentitySnapshotLoader extends AbstractSsoLegacyIdentitySnapshotLoader {
     ...
     */
    public SsoSlaveLegacyIdentitySnapshotLoader(SysOrgMapper sysOrgMapper,
