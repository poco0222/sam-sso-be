...
/**
 * 负责从 SQL Server `slavexx` 读取 legacy 身份快照。
 */
@Component
@DataSource(DataSourceType.SLAVEXX)
public class SsoSlaveXxLegacyIdentitySnapshotLoader extends AbstractSsoLegacyIdentitySnapshotLoader {
     ...
     */
    public SsoSlaveXxLegacyIdentitySnapshotLoader(SysOrgMapper sysOrgMapper,
