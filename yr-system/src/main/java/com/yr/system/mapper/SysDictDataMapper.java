...
public interface SysDictDataMapper {
    ...
    public SysDictData selectDictDataByTypeAndLable(@Param("dictType") String dictType,@Param("dictLabel") String dictLabel);
    ...
    SysDictData selectDictByValue(@Param("dictValue") String dictValue);
}
