...
/**
 * SysMobileLoginService
 *
 * @author Youngron
 * @since 2022-03-16 08:55
 */
@Component
public class SysMobileLoginService {

    private static final Logger log = LoggerFactory.getLogger(SysMobileLoginService.class);
