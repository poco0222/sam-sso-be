...
public class DataScopeAspect {
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias) {
        ...
        if (StringUtils.isNotBlank(sqlString.toString())) {
            ...
            if (StringUtils.isNotNull(params)) {
                ...
                } else if (params instanceof CustomEntity) {
                    CustomEntity customEntity = (CustomEntity) params;
                    customEntity.getParams().put(DATA_SCOPE, " AND (" + sqlString.substring(4) + ")");
                }
            }
        }
    }
    ...
    // 配置织入点
    @Pointcut("@annotation(com.yr.common.annotation.DataScope)")
    ...
    private void clearDataScope(final JoinPoint joinPoint) {
        ...
        if (StringUtils.isNotNull(params)) {
            if (params instanceof BaseEntity) {
                ...
                CustomEntity customEntity = (CustomEntity) params;
                customEntity.getParams().put(DATA_SCOPE, "");
            }
        }
    }
}
