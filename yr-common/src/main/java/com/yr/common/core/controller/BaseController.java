package com.yr.common.core.controller;
...
import com.yr.common.utils.sql.SqlUtil;
...
public class BaseController {
    ...
    /**
     * 响应请求分页数据-通过mybatis的分页对象
     */
    @SuppressWarnings({"rawtypes", "unchecked"})
    protected <T> TableDataInfo getDataTableByPage(IPage<T> page) {
        TableDataInfo rspData = new TableDataInfo();
        rspData.setCode(HttpStatus.SUCCESS);
        rspData.setMsg("查询成功");
